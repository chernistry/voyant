...
async function tryPrimaryWeatherAPI(city) {
    try {
        ...
        const url = `https://api.open-meteo.com/v1/forecast?latitude=${first.latitude}&longitude=${first.longitude}` +
...
async function tryWeatherFallback(city, datesOrMonth) {
